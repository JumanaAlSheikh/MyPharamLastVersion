...
//              "Send Request to Server Timeout: ${error.response.statusCode}";
  ...
  Future<PharmaResponse> gerPharmaList(String sessionId,Map<String, dynamic> data,String lang) async {
    Response response;
    print(sessionId);
    try {
      _dio.interceptors.clear();
...
//          await writeAuthKey(token);
      ...
      response = await _dio.post(
          "http://api.mypharma-order.com:8080/APIS/api/PharmacistsUser/GetPharmacistsList",data: data);
      return PharmaResponse.fromJson(response.data);
    } catch (error, stacktrace) {
      print("Exception occured: $error stackTrace: $stacktrace");
      return PharmaResponse.withError(_handleError(error));
    }
  }
/*
