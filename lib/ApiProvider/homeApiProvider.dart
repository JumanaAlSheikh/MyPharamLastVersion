...
//          await writeAuthKey(token);
  ...
  Future<loginResponse> setToken(String sessionId,Map<String, dynamic> data,String lang) async {
    Response response;
    try {
      _dio.interceptors.clear();
      _dio.interceptors
...
//          await writeAuthKey(token);
      ...
      response = await _dio.post(
          "http://api.mypharma-order.com:8080/APIS/api/Authentication/SetUserFcmToken",data: data);
      print(response);
