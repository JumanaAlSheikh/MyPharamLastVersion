...
//              "Send Request to Server Timeout: ${error.response.statusCode}";
  ...
  Future<reqResponse> getOrderReqList(String sessionId,Map<String, dynamic> data,String lang) async {
    Response response;
    try {
      _dio.interceptors.clear();
      _dio.interceptors
...
//          await writeAuthKey(token);
      ...
      response = await _dio.post(
          "http://api.mypharma-order.com:8080/APIS/api/Orders/GetOrdersLists",data: data);
      print(response.data);
      return reqResponse.fromJson(response.data);
    } catch (error, stacktrace) {
      print("Exception occured: $error stackTrace: $stacktrace");
      return reqResponse.withError(_handleError(error));
    }
  }
/*
